...
export const user: User = {
  ...
  position: 'Software Engineer • Frontend | Backend | Fullstack',
  ...
  //   description:
  //     `<p>
  //   Hi! I'm a developer based in Manila with a focus on
  //   <span style="color: rgb(41, 105, 176);"><strong>Front-end web</strong></span>
  //   and
  //   <span style="color: rgb(44, 130, 201);"><strong>Hybrid mobile applications</strong></span>,
  //   along with some experience in
  //   <span style="color: rgb(44, 130, 201);"><strong>Backend development</strong></span>.
  //   I'm passionate about building practical, user-focused applications and crafting clean, intuitive interfaces.
  //   I specialize in designing reusable
