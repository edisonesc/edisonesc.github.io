    ...
    projects: [
      {
        ...
        cv_responsibilities: [
          ...
          'Performed root-cause analysis (RCA) on workflow issues, ensuring existing systems functioned as intended working as intended and resolving defects efficiently.',
