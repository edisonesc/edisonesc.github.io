...
export const experiences: Experience[] = [
    ...
    projects: [
      {
        ...
        cv_responsibilities: [
          ...
          'Oversaw frontend architecture of a critical service during a 2-month on-site deployment in Suwon, South Korea, aligning technical decisions with business requirements and achieving the effective output of a three-person team.',

          'Established a parallel frontend-backend workflow using mock API servers and structured stubs, accelerating iteration and enabling early UI/UX validation prior to API finalization.',

          'Owned frontend production releases via GitOps workflow — coordinating artifact tagging, production branch promotion, and Argo CD synchronization across Kubernetes environments to ensure reliable, repeatable deployments.',
        ],
        ...
        responsibilities: [
          ...
          'Directed end-to-end frontend system design during HQ collaboration in Suwon, proactively identifying architectural risks and aligning implementation strategy with evolving business goals.',

          'Defined controlled integration strategy between frontend and backend teams using mock services and structured contracts to minimize downstream rework.',

          'Owned frontend production releases via GitOps workflow — coordinating artifact tagging, production branch promotion, and Argo CD synchronization across Kubernetes environments to ensure reliable, repeatable deployments.',

          'Maintained 85–90%+ unit test coverage by enforcing structured testing standards, reducing regression risk during large-scale refactors.',

          'Conducted deep root-cause analysis on architectural bottlenecks and complex production issues, eliminating recurring defects and stabilizing delivery cycles.',

          'Provided cross-functional technical leadership across planning, triage, and solution validation to maintain delivery velocity under constrained team capacity.',
        ],
      },
    ],
  },
    ...
    projects: [
      {
        ...
        cv_responsibilities: [
          'Delivered enterprise-scale solutions using GoogleSQL and JavaScript for global help center platforms supporting high-volume customer and agent workflows.',

          'Automated data validation and verification pipelines through structured reporting scripts, reducing manual effort by ~78% while improving accuracy and consistency.',

          'Guided QA reviews across 10 concurrent initiatives, identifying systemic criteria gaps early and reducing downstream defects by ~42%.',

          'Built dynamic UI components (tables, search filters) with structured API response transformations to support complex conditional business logic.',

          'Authored 17 API validation and regression workflows to detect deprecations, verify response integrity, and formalize integration documentation standards.',
        ],

        responsibilities: [
          'Executed high-level solution authoring using GoogleSQL and JavaScript for enterprise knowledge platforms serving global user bases.',

          'Streamlined cross-project validation processes by creating automated reporting tools that minimized human error and accelerated verification cycles.',

          'Performed structured root-cause analysis on workflow breakdowns, stabilizing authoring pipelines and preventing repeated production issues.',

          'Collaborated cross-functionally with designers, technical architects, and program managers to refine requirements and prevent downstream blockers.',

          'Contributed to documentation standardization and validation governance, improving long-term maintainability of integration workflows.',
        ],
      },
    ],
  },

  {
    ...
    cv_responsibilities: [
      'Built web and mobile applications using Angular and Ionic, delivering production-ready incident management and wallet platforms across Android and iOS.',

      'Managed cross-platform mobile release lifecycle, including application signing, build generation, and deployment to Google Play and Apple App Store.',

      'Created reusable frontend component libraries to improve maintainability and accelerate feature delivery.',

      'Implemented backend services using NestJS and Node.js, enabling RESTful integrations and end-to-end functionality.',

      'Developed an Augmented Reality mobile application using Unity and Vuforia (C#), rendering 3D objects and media triggered by image recognition.',
    ],

    responsibilities: [
      'Built structured Angular dashboards for incident management and wallet systems, applying component-driven architecture and state-based UI patterns.',

      'Delivered cross-platform mobile features using Ionic with Angular, supporting Android and iOS production environments.',

      'Designed AR-based interaction modules integrating computer vision triggers for real-time 3D rendering.',

      'Refactored legacy components to improve modularity, readability, and long-term maintainability.',

      'Integrated REST APIs and backend services to support seamless feature delivery across frontend and mobile clients.',
    ],
  },

  {
    ...
    location: 'Manila, PH',
    responsibilities: [
      'Built internal web application modules supporting operational business tools.',
      'Implemented interactive reporting components for structured data visualization.',
    ],
    exclude_in_cv: true,
  },
...
//           'Architected modular, highly cohesive component systems across Angular and React/Next.js, reducing delivery time for repeat features by ~75–85% based on measured release metrics.',

//           'Directed frontend architecture of a critical service during a 2-month on-site deployment in Suwon, South Korea, aligning technical decisions with business requirements and delivering the effective output of a three-person team.',

//           'Instituted a parallel frontend-backend workflow using mock API servers and constant-based stubs, accelerating iteration and enabling early UI/UX validation prior to API finalization.',
...
//           'Engineered scalable component abstractions across Angular and React ecosystems, improving maintainability and significantly reducing repetitive implementation effort.',

//           'Oversaw end-to-end frontend system design during HQ collaboration in Suwon, proactively identifying architectural risks and aligning implementation strategy with evolving business goals.',

//           'Designed controlled integration strategy between frontend and backend teams using mock services and structured contracts to minimize downstream rework.',

//           'Sustained 85–90%+ unit test coverage by instituting structured testing standards, reducing regression risk during large-scale refactors.',

//           'Performed deep root-cause analysis on architectural bottlenecks and complex production issues, eliminating recurring defects and stabilizing delivery cycles.',
...
//           'Led QA reviews across 10 concurrent initiatives, identifying systemic criteria gaps early and reducing downstream defects by ~42%.',

//           'Engineered dynamic UI components (tables, search filters) with structured API response transformations to support complex conditional business logic.',

//           'Authored 17 API validation and regression workflows to detect deprecations, verify response integrity, and formalize integration documentation standards.',
//         ],

//         responsibilities: [
//           'Implemented high-level solution authoring using GoogleSQL and JavaScript for enterprise knowledge platforms serving global user bases.',

//           'Streamlined cross-project validation processes by building automated reporting tools that minimized human error and accelerated verification cycles.',
...
//     cv_responsibilities: [
//       'Engineered web and mobile applications using Angular and Ionic, delivering production-ready incident management and wallet platforms across Android and iOS.',

//       'Managed cross-platform mobile release lifecycle, including application signing, build generation, and deployment to Google Play and Apple App Store.',

//       'Constructed reusable frontend component libraries to improve maintainability and accelerate feature delivery.',
...
//       'Developed backend features using NestJS and Node.js to support end-to-end application functionality.',
...
//       'Developed backend features using NestJS and Node.js, supporting REST API integrations and enabling end-to-end feature delivery.',
//     ],
//   },
//   {
//     title: 'ihatecomputer.com Inc.',
